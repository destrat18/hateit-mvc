...
<head>
    ...
    <style>
        ...
        * {
        ...
        html,body,h1,h2,h3,h4,h5 {font-family: "Open Sans", sans-serif; direction: rtl}
        p,button {direction: rtl}
        input {direction: ltr}
    </style>
    ...
    <script>
        ...
        function checkForm() {
            ...
            var repassword = document.loginForm.repassword;

            if (username.value == "") {
                showNotification("نام کاربری نباید خالی باشد!");
                return false;
            }
            else if(!validateEmail(username.value))
            {
                showNotification("نام کاربری باید ایمیل باشد!");
                return false;
            }
            ...
            {
                showNotification("طول گذرواژه باید بیشتر از ۵ کاراکتر باشد!");
                return false;
            }
            else if(!hasLetter(password.value)|| !hasNumber(password.value))
            {
                showNotification("گذرواژه باید شامل عدد و حرف باشد!");
                return false;
            }
            else if(password.value != repassword.value)
            {
                showNotification("گذرواژه‌ها با هم یکسان نیستند");
                return false;
            }
